...
WEBHOOK_CHANNEL = "channel_name" # the channel to which new posts should be sent via a webhook
...
SENTRY_SERVER_NAME = "Microsub Client and Server" # the name of your server for use in Sentry
